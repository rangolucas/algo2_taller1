...
private:
    ...
    struct Nodo {
        ...
        Nodo* _sig;
        Nodo* _ant;
        Nodo(T valor, Nodo* sig, Nodo* ant):_valor(valor), _sig(sig), _ant(ant){}
    };
    ...
    /**
     * Devuelve una referencia al nodo en la i-esima posicion.
     * Pre: la lista tiene al menos i + 1 elementos
     */
